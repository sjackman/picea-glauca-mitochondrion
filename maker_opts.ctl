...
#est=NC_010303.frn #set of ESTs or assembled mRNA-seq in fasta format

#-----Protein Homology Evidence (for best results provide a file for at least one)
protein=NC_010303.faa #protein sequence file in fasta format (i.e. from mutiple oransisms)
